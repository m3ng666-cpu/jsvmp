...
function cbbjsvmp(soure,outpath){
    ...
    function startgetType(node, variablePool, zhili){
        ...
        switch(node.type){
            ...
            case "ForInStatement":
                ...
                zhili.push(toPool("for_in_xh_jsvmp"+fbme))
                ...
                zhili.push(RandDataCheise(zhilDx.z23))
                zhili.push(RandDataCheise(zhilDx.z10))
                zhili.push(toPool("for_in_xh_jsvmp_list"+fbme))
                zhili.push(RandDataCheise(zhilDx.z181))
                zhili.push(RandDataCheise(zhilDx.z10))
                ...
                dyyy.push(toPool( "for_in_xh_jsvmp_list"+fbme))
                dyyy.push(RandDataCheise(zhilDx.z181))
                dyyy.push(RandDataCheise(zhilDx.z23))
                dyyy.push(RandDataCheise(zhilDx.z10))
                dyyy.push(toPool("for_in_xh_jsvmp"+fbme))
                dyyy.push(RandDataCheise(zhilDx.z181))
                dyyy.push(RandDataCheise(zhilDx.z181))
                ...
                for (let i =0; i< bbblenko; i++){
                    if (dyyy[i] == "jsvmp_break_in_the_this_yhh_417"){
                        dyyy[i] = RandDataCheise(zhilDx.z190);
                        dyyy[i+1] = bbblenko - i - 2
                    }else if (dyyy[i] == "jsvmp_continue_in_the_this_yhh_417"){
                        dyyy[i] = RandDataCheise(zhilDx.z190);
            ...
            case "BreakStatement":
                if (node.label){
                    ...
                    zhili.push("jsvmp_break_in_the_this_yhh_417")
                    zhili.push(undefined)
                }
                break
            ...
            case "ForStatement":
                ...
                for (let i =0; i< lenko; i++){
                    if (fgfgfdsujj[i] == "jsvmp_break_in_the_this_yhh_417"){
                        fgfgfdsujj[i] = RandDataCheise(zhilDx.z190);
                        fgfgfdsujj[i+1] = lenko - i - 2
                    }else if (fgfgfdsujj[i] == "jsvmp_continue_in_the_this_yhh_417"){
                        fgfgfdsujj[i] = RandDataCheise(zhilDx.z190);
            ...
            case "WhileStatement":
                ...
                for (let i =0; i< ffflenko; i++){
                    if (jiiiujj[i] == "jsvmp_break_in_the_this_yhh_417"){
                        jiiiujj[i] = RandDataCheise(zhilDx.z190);
                        jiiiujj[i+1] = ffflenko - i - 2
                    }else if (jiiiujj[i] == "jsvmp_continue_in_the_this_yhh_417"){
                        jiiiujj[i] = RandDataCheise(zhilDx.z190);
            ...
            case "DoWhileStatement":
                ...
                for (let i =0; i< lenkoe; i++){
                    if (ujj[i] == "jsvmp_break_in_the_this_yhh_417"){
                        ujj[i] = RandDataCheise(zhilDx.z190);
                        ujj[i+1] = lenkoe - i - 2
                    }else if (ujj[i] == "jsvmp_continue_in_the_this_yhh_417"){
                        ujj[i] = RandDataCheise(zhilDx.z190);
                        ujj[i+1] =  lenkoe - i - 4
                    }
                }
            ...
            case "ContinueStatement":
                zhili.push("jsvmp_continue_in_the_this_yhh_417")
                zhili.push(undefined)
                break
            ...
            case "SwitchStatement":
                ...
                zhili.push(RandDataCheise(zhilDx.z10))
                zhili.push(toPool(gggjsvmp.length))

                zhili.push(RandDataCheise(zhilDx.z48))
                zhili.push(hu+1)
                let oolenko = gggjsvmp.length
                for (let i =0; i< oolenko; i++){
                    if (gggjsvmp[i] == "jsvmp_break_in_the_this_yhh_417"){
                        gggjsvmp[i] = RandDataCheise(zhilDx.z190);
                        gggjsvmp[i+1] = oolenko - i -2
                    }
                }

                copyArrayList(zhili, gggjsvmp)
            ...
            case "FunctionDeclaration":
                variablePool[node.id.name] = "awjsvmp_yhh_fun"+numberKuai
                startfun(node)
                break
            ...
            case "FunctionExpression":
                let bcxh
                if (node.id){
                    bcxh = "awjsvmp_yhh_fun"+numberKuai
    ...
    function startfun(node2){
        let name = "awjsvmp_yhh_fun"+numberKuai
        numberKuai += 1
        ...
        for (let i in changlc[name]['variablePool']){
            if (changlc[name]['variablePool'][i] && changlc[name]['variablePool'][i].indexOf("awjsvmp_yhh_fun") != -1){
...
// 需要加密的js
//const soure = "3.js"
//const outpath = "./outsrc/65.js"
//jsvmpjsvmp(soure,outpath)
